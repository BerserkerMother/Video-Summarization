...
def eval_metrics(data, user_dict, args):
    ...
    for video_name in keys:
        user_summary = user_dict[video_name].user_summary
        user_scores = user_dict[video_name].user_scores
        sb = user_dict[video_name].change_points
        n_frames = user_dict[video_name].n_frames
        positions = user_dict[video_name].picks
